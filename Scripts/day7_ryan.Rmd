...
joined_df %>% ggplot(aes(x = age, fill = Failures)) + geom_density(alpha = 0.5)+theme_minimal()+labs(title = "Age vs Failures")+ylab("Density of Failures")+theme(plot.title = element_text(hjust =0.5 ))+scale_x_continuous(name = "Age",limits = c(20,80))
