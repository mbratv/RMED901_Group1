...
Deciding to join the original dataframe to the ad_df by the column "id" as this is present in both datasets. We have provided further explanatations for each of the functions used inside the code-chunk. 
```{r}
joined_df <- data2 %>% 
...
## The second question is answered in heat map above. The randomization is slightly negatively correlated with BMI. 
