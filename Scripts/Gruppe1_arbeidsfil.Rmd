...
# We see that XXX... is positively correlated with XXX and XXX is negatively correlated with XXX
joined_df %>%
...
# Checking if age and BMI have a linear relationship by adding geom_smooth (adds a regression line) to a scatterplot. Also removed the grey background and the grids. We set the x-asis limit from 20 to 80. 
```
