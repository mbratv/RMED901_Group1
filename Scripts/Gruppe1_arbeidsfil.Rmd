...
joined_df %>% summarise(across(everything(), ~sum(is.na(.)))) #Checking for missing values in the dataset. There are 2 missing values for BMI,  1 for sore_throat, 1 for mallampati and 1 for mallampati_asa
